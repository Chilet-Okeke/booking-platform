        ...
        >
          ...
          <div className="flex flex-col items-center justify-center gap-6">
            ...
            <h3 className="text-2xl text-white font-booking_font4">
              <Link
                ...
                className="hover:text-[var(--gold-1)] text-white" to={'https://www.instagram.com/zyrastones_living?igsh=MzRIODBiNWFIZA'}>
                @zyrastones_living
              </Link>
            </h3>
          </div>
          <div className="flex flex-col items-center justify-center gap-6">
            ...
            <h3 className="text-2xl flex flex-col items-center justify-center gap-4 text-white font-booking_font4">
              ...
              <Link
                className="hover:text-[var(--gold-1)] text-white" mailto={'zyraandstones@gmail.com'}>
