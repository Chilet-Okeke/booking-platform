            ...
            <div className="w-full grid relative grid-cols-1 md:items-center lg:grid-cols-custom_5 gap-4 lg:gap-24">
              <div className="flex pr-2 lg:pr-12 flex-col gap-12 w-full">
                ...
                <div className="w-full flex flex-col gap-8">
                 ...
                 One more step to complete your booking with Zyra&Stones Living. Our payment platform ensures your payment details are safe and secured.
                    </li>
                  </ul>
                </div>
                {/* payment features */}
                <div className="w-full flex flex-col gap-8">
                  ...
                  <ul className="flex flex-col gap-4 pb-12 border-b">
                    <li className="text-base flex items-center gap-2 font-booking_font font-normal">
                      <BiCheck fontSize={"24px"} /> Take advantage of our serene environment to relax in comfort and luxury.
                    </li>

                    <li className="text-base flex items-start gap-2 font-booking_font font-normal">
                      <BiCheck fontSize={"24px"} /> Book with us to get the best rates available.
                       Get immediate confirmation of your booking.
