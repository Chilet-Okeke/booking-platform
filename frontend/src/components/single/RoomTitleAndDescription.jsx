    ...
    <>
      <div className="w-full flex flex-col gap-8">
        ...
        <div className="w-full py-12 mt-3  border-t border-b flex flex-col gap-6">
          ...
          <h4 className="text-lg leading-[1.8] block font-booking_font font-normal text-dark">
            With our single bedroom in a gated estate, Lekki. Feel free to treat yourself to a luxurious getaway
            filled with comfort, relaxation and unforgettable memories.
          </h4>
          
          <h4 className="text-lg leading-[1.8] block font-booking_font font-normal text-dark">
            SLEEPS {room?.guests} People - {room?.bedroom} Bedroom, {room?.bathroom} Bathroom. - 1 Car
            MAX!
          </h4>
