...
const Collections = () => {
  ...
  return (
    <div
      data-scroll-section
      className="w-full flex flex-col gap-32 md:gap-40"
    >
      <div
...
const RoomStructure = () => {
  ...
  return (
    <div data-scroll-section className="w-full flex py-40 flex-col gap-20">
            ...
            <span className="w-full overflow-hidden">
              ...
              >
                ...
                <Link style={{ textDecoration: "underline" }}
                  className="text-[var(--gold-1)]" mailto={'zyraandstones@gmail.com'}>
                  zyraandstones@gmail.com
                </Link>
                {" "}
                or {" "}
                <Link style={{ textDecoration: "underline" }} className="text-[var(--gold-1)]" to={''}>
                  +(234) 913 861 1598
                </Link>
                . Follow us on IG:
                {" "}
                <Link
                  ...
                  className="text-[var(--gold-1)]" to={'https://www.instagram.com/zyrastones_living?igsh=MzRIODBiNWFIZA'}>
                  @zyrastones_living
                </Link>
